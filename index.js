...
function postUser(req,res){
    ...
    console.log (`insert into utilizadores (name, age) values ("${req.body.username}",${req.body.age})`);
    connection.query(`insert into utilizadores (name, age) values ("${req.body.username}",${req.body.age})`)
}
